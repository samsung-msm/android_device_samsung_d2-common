...
static const struct sensor_t sSensorList[] = {
        ...
        { "BMP180 Pressure sensor",
          ...
          SENSOR_TYPE_PRESSURE, 1100.0f, 0.01f, 0.05, 50000, 0, 0,
          SENSOR_STRING_TYPE_PRESSURE, "", 0, SENSOR_FLAG_CONTINUOUS_MODE, { } },
        { "BMP180 Temperature sensor",
          "Bosch",
          1, SENSORS_TEMPERATURE_HANDLE,
          SENSOR_TYPE_AMBIENT_TEMPERATURE, 850.0f, 0.1f, 0.5f, 50000, 0, 0,
          SENSOR_STRING_TYPE_AMBIENT_TEMPERATURE, "", 0, SENSOR_FLAG_CONTINUOUS_MODE, { } },
};
...
struct sensors_poll_context_t {
    sensors_poll_device_t device; // must be first
